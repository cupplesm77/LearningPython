...
# What value to set to args4.ignore_duplicates above (in the tests)?
# Two scenarios:
# 1) --ignore-duplicates not supplied
#    => set to default value of False
# 2) --ignore-duplicates is supplied
#    => "store_true" action triggered
#    => set to True
