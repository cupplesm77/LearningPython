...
terse_handler = logging.FileHandler(LOGFILE_TERSE)
terse_handler.setLevel(logging.ERROR)
my_logger.addHandler(terse_handler)

verbose_handler = logging.FileHandler(LOGFILE_VERBOSE)
my_logger.addHandler(verbose_handler)

thorough_handler = logging.FileHandler(LOGFILE_THOROUGH)
thorough_handler.setLevel(logging.INFO)
my_logger.addHandler(thorough_handler)
