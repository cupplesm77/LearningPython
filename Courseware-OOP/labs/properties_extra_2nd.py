...
class Resistor:
    ...
    @current.setter
    def current(self, current_value):
        self.voltage = current_value * self.resistance
    ...
    def current_in_milliamps(self, milliamp_value):
        self.current = milliamp_value / 1000
...
resistor.voltage = 1000
print(resistor.voltage)
