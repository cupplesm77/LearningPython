...
# extract to a set the "Years_Coding" column from dataframe df

df_years_coding = df[['Years_Coding']]
print(df_years_coding.info())

y = set(df["Years_Coding"])
print(type(y))
print(len(y))
print(f"y = \n{y}")
#